...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $tournaments = Tournament::withCount('registrations', 'participations')->orderBy('registrations_count', 'desc')->orderBy('endDate', 'asc')->paginate(10);
    ...
    */
    public function listRegistrations(Request $request) {
        ...
        return view('admin.registrations')->with('registrations', $registrations)->with('tournament', Tournament::find($request->id));
    }
