...
<div class="wrapperAppeared">
  ...
  <div class="buttonArea">
      ...
      <a href="{{ route('begin') }}" style="@yield('fightLinkEnable');"><button type="button" class="btn btn-default @yield('fightButtonEnable')">
				<img src="images-Borbe/boxing.png" height="70" />
			</button></a>

      <a href="{{ route('begin') }}" style="@yield('pokeLinkEnable');"><button type="button" class="btn btn-default @yield('pokeButtonEnable')">
